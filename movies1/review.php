	...
	<div class="container allratings">
		<div class="row">
			...
			<div class="col-6">
				...
				$query = "SELECT userinfo.username, movie_reviews.movie_id, movie_reviews.ratings FROM userinfo JOIN movie_reviews ON movie_reviews.user_id = userinfo.user_id WHERE movie_reviews.movie_id='$movieid'";
				$result = mysqli_query($con, $query);
